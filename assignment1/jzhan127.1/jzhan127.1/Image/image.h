...
/** This struct represents an exception thrown by the Image32 class. */
struct ImageException : public std::runtime_error
{
	ImageException( const std::string & msg ) : std::runtime_error( std::string( "Image: " ) + msg ) {}
};
