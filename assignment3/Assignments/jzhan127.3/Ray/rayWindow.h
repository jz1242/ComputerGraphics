...
class RayWindow
{
	/** A boolean indicating if the OpenGL state has been set.*/
	static bool _openGLSet;
	/** An integer value indicating the resolution of refinement.*/
	static int _sceneComplexity;
public:
