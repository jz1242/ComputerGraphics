...
/** This struct represents an exception thrown by the OrientedLineSegmentPairs class. */
struct LineSegmentsException : public std::runtime_error
{
	LineSegmentsException( const std::string & msg ) : std::runtime_error( std::string( "LineSegments: " ) + msg ) {}
};
