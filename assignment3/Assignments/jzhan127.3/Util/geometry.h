...
/** This struct represents an exception thrown by the Geometry class. */
struct GeometryException : public std::runtime_error
{
	GeometryException( const std::string & msg ) : std::runtime_error( std::string( "Geometry: " ) + msg ) {}
};
...
public:
	...
	/** This static method returns the dot product of two points.*/
	static double Dot( const Point2D& p , const Point2D& q );
...
public:
	...
	/** This static method returns the dot product of two points.*/
	static double Dot( const Point3D& p , const Point3D& q );
	...
	static Point3D CrossProduct( const Point3D& p , const Point3D& q );
};
...
public:
	...
	static double Dot( const Matrix3D& m , const Matrix3D& n );

	/** This method returns the squared Frobenius norm of the matrix */
	double squareNorm( void ) const;
...
public:
	...
	/** This constructor generates an identity matrix */
	Matrix4D( void );
	/** This constructor initializes the entries of the matrix */
	...
	/** This static method returns the dot product of two matrices */
	static double Dot( const Matrix4D& m , const Matrix4D& n );
	/** This method returns the sum of the squared Frobenius norm of the matrix */
	double squareNorm( void ) const;
	/** This method returns the sum of the Frobenius norm of the matrix */
	double length( void ) const;
};
...
public:
	...
	/** Default constructor sets this to the identity transformation */
	Quaternion( void );
...
public:
	...
	/** This constructor copies the Euler angles and translation */
	EulerAnglesAndTranslation( const Point3D& eulerAngles , const Point3D& translate );
...
public:
	...
	/** This constructor copies the rotation and translation */
	RotationAndTranslation( const Matrix3D& r , const Point3D& t );
...
public:
	...
	/** This constructor copies the skew-symmetric matrix and translation */
	LogRotationAndTranslation( const Matrix3D& s , const Point3D& t );
...
public:
	...
	/** This constructor copies the quaternion and the translation */
	QuaternionAndTranslation( const Quaternion& q , const Point3D& t );
